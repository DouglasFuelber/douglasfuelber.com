...
{intl.formatMessage({ id: `resume.publications.${key}.type` })}
{' '}
|
{' '}
<span className="publication-language">{intl.formatMessage({ id: `resume.publications.${key}.language` })}</span>
</div>
              <h4 className="publication-title">
                  <a href={intl.formatMessage({ id: `resume.publications.${key}.link` })} target="_blank" rel="noopener">
...
<i class="fas fa-external-link-alt external-link-icon"></i>
              ...
              <div className="publication-colaborator">
                  <span className="publication-colaborator-role">
{intl.formatMessage({ id: `resume.publications.${key}.colaborator.role` })}
:
{' '}
</span>
