module.exports = {
  ...
  siteTitleAlt: "Douglas Fuelber - Desenvolvedor Full Stack", // Alternative site title for SEO.
  ...
  siteDescription: "Douglas Fuelber - Bacharel em Ciência da Computação pela UNISC e desenvolvedor na Conectt.", // Website description used for RSS feeds/meta description tag.
  siteRss: "/rss.xml", // Path to the RSS file.
  siteFBAppID: "", // FB Application ID for using app insights
  siteGATrackingID: "UA-99213358-1", // Tracking code ID for google analytics.
  disqusShortname: "douglasfuelber", // Disqus shortname.
